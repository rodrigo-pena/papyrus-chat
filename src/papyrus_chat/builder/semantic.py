...
def build_subject_index(
    ...
    *,
    ...
    vectors = tuple(
        normalize_embedding(vector, dimensions=encoder.model_spec.dimensions)
    ...
    return SemanticIndexBuild(
        ...
        manifest=SemanticIndexInfo(
            ...
            model_file=encoder.model_spec.model_file,
            query_prefix=encoder.model_spec.query_prefix,
            passage_prefix=encoder.model_spec.passage_prefix,
            pooling=encoder.model_spec.pooling,
